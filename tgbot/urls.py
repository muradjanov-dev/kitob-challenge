...
from .views import home, telegram, library_view, internal_broadcast_library_music
...
urlpatterns = [
    ...
    path("internal/broadcast/library-music/", internal_broadcast_library_music, name="internal-broadcast-library-music"),
